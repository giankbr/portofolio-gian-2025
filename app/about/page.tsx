        ...
        <div className="about-page-content prose dark:prose-invert max-w-none">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
              ...
              {/* Fix text colors to support light/dark mode */}
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              {/* Continue updating text colors for light/dark mode */}
              <div>
                ...
                <div className="space-y-6">
                  <div className="border-l-2 border-purple-600 pl-6">
                    ...
                    <p className="text-purple-600 dark:text-purple-500 mb-2">Morfotech • 2022 - Present</p>
                  ...
                  <div className="border-l-2 border-zinc-300 dark:border-zinc-800 pl-6">
                    <h3 className="text-xl font-medium">Frontend Developer</h3>
                    <p className="text-zinc-600 dark:text-zinc-500 mb-2">Previous Company • 2020 - 2022</p>
                    <p className="text-zinc-600 dark:text-zinc-400">Built responsive user interfaces using modern JavaScript frameworks. Implemented design systems and component libraries.</p>
                  </div>
                </div>
              </div>

              {/* Update skills section for light/dark mode */}
              <div>
