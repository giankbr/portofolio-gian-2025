    ...
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white pt-24">
      ...
      <section className="py-16 bg-gradient-to-b from-white to-zinc-50 dark:from-black dark:to-zinc-900/40" id="github-activity">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Contribution graph */}
          {/* <div className="bg-white dark:bg-zinc-900 rounded-xl p-6 shadow-sm border border-zinc-100 dark:border-zinc-800 mb-10 github-item">
            <h3 className="text-2xl font-bold mb-6 flex items-center gap-2">
              <Star className="w-5 h-5 text-purple-600 dark:text-purple-500" />
              Contribution Calendar
            </h3>
            <div className="overflow-hidden rounded-lg bg-white dark:bg-zinc-900 p-4">
              <img src="https://github-contribution-stats.vercel.app/api/?username=giankbr" alt="GitHub Contribution Calendar" className="w-full max-w-4xl mx-auto" />
            </div>
          </div> */}
      ...
      {/* Footer */}
      {/* Fixed Footer - with proper spacing and structure */}
